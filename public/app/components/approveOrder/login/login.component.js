...
var Login = (function () {
    ...
    Login = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof app_service_1.AppService !== 'undefined' && app_service_1.AppService) === 'function' && _a) || Object, router_1.Router, forms_1.FormBuilder, router_1.ActivatedRoute])
    ], Login);
    return Login;
    var _a;
}());
